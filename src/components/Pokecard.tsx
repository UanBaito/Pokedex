...
export default function Pokecard({
  ...
  return (
    <li className="grow flex justify-center poke-card-li">
      <button
        className={`relative grid justify-center grid-flow-col p-2 grid-cols-6 grid-rows-6 grow shadow-2xl h-52  mx-2 my-2 cursor-pointer poke-card bg-slate-300 border-4`}
        onClick={(e) => {
          e.preventDefault();
